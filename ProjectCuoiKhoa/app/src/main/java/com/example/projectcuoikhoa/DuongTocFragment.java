...
public class DuongTocFragment extends Fragment {
    ImageView imgBack, imgGioHang;
    GridView lvProduct;
    String str;
    static TextView tvSoLuongGioHang;
    AdapterProduct adapterProduct;
    public static DuongTocFragment newInstance() {
        Bundle args = new Bundle();
        DuongTocFragment fragment = new DuongTocFragment();
