...
public class HangMoiVeFragment extends Fragment {
    ...
    public static HangMoiVeFragment newInstance() {
        Bundle args = new Bundle();
        HangMoiVeFragment fragment = new HangMoiVeFragment();
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    if(type.trim().equals("hàng mới về")||type.trim().equals("nước hoa")){
