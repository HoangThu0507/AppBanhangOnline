...
public class TrangDiemFragment extends Fragment {
    ...
    public static TrangDiemFragment newInstance() {
        Bundle args = new Bundle();
        TrangDiemFragment fragment = new TrangDiemFragment();
