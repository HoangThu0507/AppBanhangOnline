...
public class NuocHoaFragment extends Fragment {
    ...
    public static NuocHoaFragment newInstance() {
        Bundle args = new Bundle();
        NuocHoaFragment fragment = new NuocHoaFragment();
